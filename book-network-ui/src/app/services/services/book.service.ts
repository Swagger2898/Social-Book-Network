...
import { saveBook1 } from '../fn/book/save-book-1';
import { SaveBook1$Params } from '../fn/book/save-book-1';
...
export class BookService extends BaseService {
  ...
  /** Path part for operation `saveBook1()` */
  static readonly SaveBook1Path = '/';

  /**
   * This method provides access to the full `HttpResponse`, allowing access to response headers.
   * To access only the response body, use `saveBook1()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveBook1$Response(params: SaveBook1$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
    return saveBook1(this.http, this.rootUrl, params, context);
  }

  /**
   * This method provides access only to the response body.
   * To access the full response (for headers, for example), `saveBook1$Response()` instead.
   *
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  saveBook1(params: SaveBook1$Params, context?: HttpContext): Observable<number> {
    return this.saveBook1$Response(params, context).pipe(
      map((r: StrictHttpResponse<number>): number => r.body)
    );
  }
